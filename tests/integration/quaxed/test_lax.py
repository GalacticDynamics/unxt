...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("eq", (x_L, x_L), {}, u.Q(lax.eq(x_val, x_val), unit="")),
        ...
        ("ge", (x_L, y_L), {}, u.Q(lax.ge(x_val, y_val), unit="")),
        ("gt", (x_L, y_L), {}, u.Q(lax.gt(x_val, y_val), unit="")),
        ...
        ("le", (x_L, y_L), {}, u.Q(lax.le(x_val, y_val), unit="")),
        ...
        ("lt", (x_L, y_L), {}, u.Q(lax.lt(x_val, y_val), unit="")),
        ...
        ("ne", (x_L, y_L), {}, u.Q(lax.ne(x_val, y_val), unit="")),
